...
DB_FILE = 'finops_intelligence_base.db'
...
def init_db():
    ...
    conn.commit()
    conn.close()
    print("FinOps Intelligence Base database initialized")
...
def get_finops_intelligence_base_summary(customer_id=None):
    init_db()
    conn = get_db()
    cursor = conn.cursor()
...
if __name__ == "__main__":
    ...
    print(f"\nFinOps Intelligence Base Summary:")
